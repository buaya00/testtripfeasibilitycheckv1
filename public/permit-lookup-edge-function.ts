// ══════════════════════════════════════════════════════════════════════
// PERMIT-LOOKUP — Edge Function Source (Reference Export)
// ══════════════════════════════════════════════════════════════════════
// This is the complete source code for the permit-lookup edge function.
// Exported as a standalone reference file for transfer to other projects.
//
// Runtime: Deno (Supabase Edge Functions)
// AI Models: Perplexity sonar-pro (grounding) + Gemini 2.5 Flash (extraction)
// ══════════════════════════════════════════════════════════════════════
